...
import 'forgot_pass_via_email.dart';
import 'forgot_pass_via_phone.dart';

class ForgotPasswordStep2 extends StatefulWidget {
  ForgotPasswordStep2({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RoundButton2(
                      ...
                      width: Get.width,
                      onPressed: () async {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotPassViaEmail()));
                      },
                      buttonColor: kBlue,
                    ),
                    SizedBox(height: Get.height * 0.02),
                    RoundButton2(
                      ...
                      onPressed: () async {
                        print('loginEmailController ${loginEmailController.text}');
                        print('loginPasswordController ${loginPasswordController.text}');
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotPassViaPhone()));
                      },
                      buttonColor: kBlue,
